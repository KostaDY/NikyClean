...
TRADES_PATH = "/Users/kostayanev/NikyClean/TRADES.xlsx"

SHEET_NAME  = "Transactions"
TABLE_NAME  = "TabTrans"

# DATA columns ONLY (import)
...
def safe_update_table(csv_file, xlsx_file, sheet_name, table_name, data_cols):
    ...
    # map table header → column offset
...
if __name__ == "__main__":
    wb = safe_update_table(CSV_PATH, TRADES_PATH, SHEET_NAME, TABLE_NAME, DATA_COLUMNS)
    atomic_save(wb, TRADES_PATH)
